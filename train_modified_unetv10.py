...
os.makedirs(
    "ts_seg_predictions/modified_unetv10",
    exist_ok=True
)
...
for epoch in range(EPOCHS):
    ...
    if val_dice > best_dice:
        ...
        torch.save({
            ...
            "ts_seg_checkpoints/best_modified_unetv10.pth"
        )
...
torch.save(
    model.state_dict(),
    "ts_seg_checkpoints/final_modified_unetv10.pth"
)
...
df.to_csv(
    "ts_seg_logs/modified_unetv10_log.csv",
    index=False
)
...
plt.savefig(
    "ts_seg_plots/modified_unetv10_loss.png"
)
...
plt.savefig(
    "ts_seg_plots/modified_unetv10_dice.png"
)
