...
os.makedirs(
    "ts_seg_predictions/modified_unetv7",
    exist_ok=True
)
...
class MultiTaskModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.pseudo_encoder = pseudo_encoder
    ...
    def forward(self, x):
        ...
        pseudo_features = self.pseudo_encoder(
            pseudo
        )
...
# ---------------------------------
        ...
        return gt_out, pseudo_out, ds_out
...
for epoch in range(EPOCHS):
    ...
    for batch_idx, (
        ...
        gt_out, pseudo_out, ds_out = model(images)
    ...
    if val_dice > best_dice:
        ...
        torch.save({
            ...
            "ts_seg_checkpoints/best_modified_unetv7.pth"
        )
...
torch.save(
    model.state_dict(),
    "ts_seg_checkpoints/final_modified_unetv7.pth"
)
...
df.to_csv(
    "ts_seg_logs/modified_unetv7_log.csv",
    index=False
)
...
plt.savefig(
    "ts_seg_plots/modified_unetv7_loss.png"
)
...
plt.savefig(
    "ts_seg_plots/modified_unetv7_dice.png"
)
