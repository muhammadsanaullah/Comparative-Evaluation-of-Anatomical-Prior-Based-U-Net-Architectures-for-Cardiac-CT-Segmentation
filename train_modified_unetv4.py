...
os.makedirs(
    "ts_seg_predictions/modified_unetv4",
    exist_ok=True
)
...
class MultiTaskModel(nn.Module):
    ...
    def forward(self, x):
        ...
        features = F.dropout3d(features,p=0.2,training=self.training)
...
for epoch in range(EPOCHS):
    ...
    if val_dice > best_dice:
        ...
        torch.save({
            ...
            "ts_seg_checkpoints/best_modified_unetv4.pth"
        )
...
torch.save(
    model.state_dict(),
    "ts_seg_checkpoints/final_modified_unetv4.pth"
)
...
df.to_csv(
    "ts_seg_logs/modified_unetv4_log.csv",
    index=False
)
...
plt.savefig(
    "ts_seg_plots/modified_unetv4_loss.png"
)
...
plt.savefig(
    "ts_seg_plots/modified_unetv4_dice.png"
)
