...
os.makedirs(
    "ts_seg_predictions/modified_unet",
    exist_ok=True
)
...
class ModifiedCardiacDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image, gt.squeeze(0), pseudo.squeeze(0)
...
for epoch in range(EPOCHS):
    ...
    if val_dice > best_dice:
        ...
        torch.save(
            model.state_dict(),
            "ts_seg_checkpoints/best_modified_unet.pth"
        )
...
torch.save(
    model.state_dict(),
    "ts_seg_checkpoints/final_modified_unet.pth"
)
...
df.to_csv(
    "ts_seg_logs/modified_unet_log.csv",
    index=False
)
...
plt.savefig(
    "ts_seg_plots/modified_unet_loss.png"
)
...
plt.savefig(
    "ts_seg_plots/modified_unet_dice.png"
)
